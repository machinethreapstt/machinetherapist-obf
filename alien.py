...
System.Clear()
System.Title("ALIEN DEVELOPMENT OBFUSCATOR")
System.Size(100, 30)
...
def main():
    ...
    print("\n"*2)
    print(Colorate.Diagonal(Colors.white_to_black, Center.XCenter(text)))
    print("\n"*5)


    _file = Write.Input("Python Dosyanızı Sürükleyin -> ", Colors.white_to_black, interval=0.005)



    if not _file.strip() or not isfile(_file):
        Colorate.Error("Dosya mevcut değil!")
        return
    ...
    try:
        ...
        Colorate.Error("Geçersiz Anahtar!")
        return
...
Renaming PYC file..."""))
    ...
    Write.Input("Oluşturuldu!", Colors.red_to_yellow, interval=0.005)
    return exit()
